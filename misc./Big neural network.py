""" Make a neural network with a lot of inputs. This is 441000 """
...
input_neurons = len(b)     #Each number in the file is one input
...
numb_input_weights = input_neurons * hidden_neurons  #This is how many weights you'll need for the first layer

""" Make a dictionary of weights for each hidden neuron. The number of lists = number of
neurons and the length of the lists are the number of neurons in the input layer """

numb_hid_neurons = []   #Will eventually have the numbers 0 to number of hidden neurons

for i in range(hidden_neurons):    
     numb_hid_neurons.append(i)    #Adds in the numbers

Hidden_layer = {}     #This dictionary will have as many keys as hidden neurons, and will have a list of weights
for a in numb_hid_neurons:         
    Hidden_layer[f'{a}' ] = np.random.uniform(-2, 2,input_neurons)  #Generates a list with as many weights as there are input_neurons.
